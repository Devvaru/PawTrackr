...
-- 1 dog -- 2 horse -- 3 cat -- 4 gecko -- 5 frog -- 6 cat -- 7 dog
  ...
  (1, 'Tuffy', 'images/collie.jpg', '2019-06-05', 'Afollie', ARRAY['6'], 'Feed him with quality dry dog food', 'Prefers not to walk in the rain'),
  (1, 'Avocado', 'images/parakeet.jpg', '2020-02-24', 'Parakeet', ARRAY['0.2'], 'Seeds and veggies', 'Likes to watch TV'),
  (1, 'Pebble', 'images/tortoise.jpg', '1980-05-17', 'Tortoise', ARRAY['10'], 'Leafy greens', 'Enjoys walking around the house'),
